...
- **UI Enhancements**:
  ...
  - Modal component: Added `hideCancel` option for single-button dialogs
  - LDAP settings form: Improved layout and spacing
- **Bug Fixes**:
  - Fixed empty log lines in Go backend logging hook
  - Removed `\r\n` suffix from log API responses for cleaner data
