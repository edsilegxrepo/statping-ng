<template>
  <div class="container col-md-7 col-sm-12 mt-2 sm-container">
    <div class="col-12 mb-5 text-center">
      <h1
        class="text-uppercase font-weight-bold text-dark mb-0"
        style="
          letter-spacing: 6px;
      ...
      <div class="card shadow-sm border-0">
        <div class="card-body p-5">
          ...
          <p class="text-muted mb-5">
            Your Enterprise Monitoring Platform is ready. Below are your generated credentials. Please save them now, as
          ...
          <div v-if="generatedAdmin" class="bg-light p-4 rounded mb-4 text-left border">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="text-break"
                ><strong>Password:</strong> <code class="bg-white p-1 rounded border">{{ generatedAdmin }}</code></span
              >
            </div>
          </div>

          <div
            v-if="generatedSamples && Object.keys(generatedSamples).length > 0"
            class="bg-light p-4 rounded mb-5 text-left border"
          >
            ...
            <div v-for="(pass, user) in generatedSamples" :key="user" class="mb-3 last-child-mb-0">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <span class="text-break"
                  ><strong>Password:</strong> <code class="bg-white p-1 rounded border">{{ pass }}</code></span
                >
              </div>
            </div>
          </div>

          <button @click="goToDashboard" class="btn btn-primary btn-lg px-5 shadow-sm">Continue to Dashboard</button>
        </div>
      </div>
    </div>
    ...
    <div v-else class="col-12">
      <form @submit.prevent="saveSetup">
        <div class="row">
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="form-group">
              ...
              <input
                ...
                type="text"
                class="form-control"
                placeholder="Monitors all of my work services"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <input
                @keyup="canSubmit"
                v-model="setup.confirm_password"
                id="password_confirm"
                type="password"
                class="form-control"
                placeholder="password"
          ...
          <div class="col-12">
            <button
              @click.prevent="saveSetup"
              :disabled="disabled || loading"
              type="submit"
              class="btn btn-primary btn-block"
              :class="{ 'btn-primary': !loading, 'btn-default': loading }"
            >
