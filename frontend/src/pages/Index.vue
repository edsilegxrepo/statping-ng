    ...
    <div class="container-fluid px-md-5 sm-container">
      ...
      <div class="col-12 full-col-12">
          <div v-for="service in services_no_group" v-bind:key="service.id" class="list-group online_list mb-4">
              <router-link tag="div" :to="serviceLink(service)" class="list-group-item list-group-item-action" style="cursor: pointer;">
...
const Group = () =>
	import(/* webpackChunkName: "index" */ "@/components/Index/Group");
const Header = () =>
	import(/* webpackChunkName: "index" */ "@/components/Index/Header");
const MessageBlock = () =>
	import(/* webpackChunkName: "index" */ "@/components/Index/MessageBlock");
const ServiceBlock = () =>
	import(/* webpackChunkName: "index" */ "@/components/Service/ServiceBlock");
const GroupServiceFailures = () =>
	import(
		/* webpackChunkName: "index" */ "@/components/Index/GroupServiceFailures"
	);
const IncidentsBlock = () =>
	import(/* webpackChunkName: "index" */ "@/components/Index/IncidentsBlock");
const MessagesIcon = () =>
