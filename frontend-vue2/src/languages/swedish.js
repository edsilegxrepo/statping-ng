const swedish = {
	...
	regen_desc:
		"API-hemligheten används för att skapa uppdaterings- och borttagningsvägar. Du kan återskapa API-nycklarna om du behöver.",
	...
	assets_desc:
		"Anpassa statussidans design genom att aktivera lokala resurser. Detta skapar en 'assets'-katalog som innehåller all CSS.",
